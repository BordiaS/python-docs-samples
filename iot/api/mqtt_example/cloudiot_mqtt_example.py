...
"""Python sample of connecting to Google Cloud IoT Core via MQTT, using JWT.
...
def main():
  ...
  # Publish num_messages mesages to the MQTT bridge, at a rate of 1 per second.
  for i in range(1, args.num_messages + 1):
    payload = '{}/{}-payload-{}'.format(args.registry_id, args.device_id, i)
    print 'Publishing message {}/{}: \'{}\''.format(i, args.num_messages,
                                                    payload)
